<template>
  <div>
    <h1 class="text-5xl font-bold mx-auto my-8">SHA-1</h1>
    ...
    <div class="stats stats-vertical shadow my-6">
      ...
      <div class="stat">
        ...
        <div class="stat-value">1993</div>
      </div>

      <div class="stat">
        <div class="stat-title">Digest Size</div>
        <div class="stat-value">{{ sha1.DIGEST_SIZE }}-byte</div>
      </div>

      <div class="stat">
        <div class="stat-title">Block Size</div>
        <div class="stat-value">{{ sha1.BLOCK_SIZE }}-byte</div>
      </div>
