<template>
  <div>
    <h1 class="text-5xl font-bold mx-auto my-8">ParallelHash</h1>
    <KitFormSelect title="Variant" :options="variantOptions" v-model="params.variants" />
    <div class="flex gap-2">
      <KitFormInput title="block size" v-model="params.b" />
...
import { parallelHash128, parallelHash128XOF } from 'mima-kit';
import { parallelHash256, parallelHash256XOF } from 'mima-kit';

defineOptions({
  name: 'ParallelHash',
})
const variantOptions = [
  { text: 'ParallelHash-128', value: 'ParallelHash-128' },
  { text: 'ParallelHash-128 XOF', value: 'ParallelHash-128 XOF' },
  { text: 'ParallelHash-256', value: 'ParallelHash-256' },
  { text: 'ParallelHash-256 XOF', value: 'ParallelHash-256 XOF' },
]
