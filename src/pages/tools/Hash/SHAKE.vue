<template>
  <div>
    <h1 class="text-5xl font-bold mx-auto my-8">SHAKE</h1>
...
import { B64, B64URL, HEX, UTF8, shake128, shake256 } from 'mima-kit';

defineOptions({
  name: 'SHAKE',
})
const variantOptions = [
  { text: 'SHAKE-128', value: 'SHAKE-128' },
  { text: 'SHAKE-256', value: 'SHAKE-256' },
]
